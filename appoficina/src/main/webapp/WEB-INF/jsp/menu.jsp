		...
		<ul class="nav navbar-nav">
			...
			<c:if test="${not empty user}">
				...
				<li class="nav-item"><a class="nav-link"
					href="/higienizacao/lista">Higienização</a></li>
				<li class="nav-item"><a class="nav-link" href="/mecanica/lista">Mecânica</a>
				</li>
				...
				<li class="nav-item"><a class="nav-link" href="/servico/lista">Serviço</a>
				</li>
			</c:if>
		</ul>
